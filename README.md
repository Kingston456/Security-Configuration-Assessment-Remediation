...
- **Action Taken:** Installed NTP using apt-get on the virtual machine.
...
- **Issue:** No File Integrity Monitoring tools were installed, meaning the system had no way of checking if critical files have been altered without authorization.
...
- **Action Taken:** Uninstalled Telnet using apt-get remove telnet on the Virtual Machine.
...
- **Finding 5-19586: Ensure suspicious packets are logged**
